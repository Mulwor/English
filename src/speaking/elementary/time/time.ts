...
export const time_7 = [
  ...
  { key: '6', english: 'Yes, that’s fine. Thank you!', russian: 'Да, это подходит. Спасибо!' },
];

export const time_8 = [
  { key: '1', english: 'What time is your flight?', russian: 'Во сколько твой рейс?' },
  { key: '2', english: 'At 9:45 in the morning.', russian: 'В 9:45 утра.' },
  { key: '3', english: 'Oh! You must wake up early!', russian: 'О! Тебе придется рано вставать!' },
  { key: '4', english: 'Yes, at 5 a.m.', russian: 'Да, в 5 утра.' },
  { key: '5', english: 'That’s so early! When do you arrive?', russian: 'Так рано! Когда ты прилетаешь?' },
  { key: '6', english: 'At 2 p.m. in New York.', russian: 'В 14:00 в Нью-Йорке.' },
];
