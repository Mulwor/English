...
import { allShopping, shopping_1, shopping_10, shopping_2, shopping_3, shopping_4, shopping_5, shopping_6, shopping_7, shopping_8, shopping_9 } from "../../data/shopping";
...
export const Shopping = () => {
  ...
  return (
    <div>
      ...
      <Collapse accordion>
        <Panel header="Shopping list" key="1">
          <Table dataSource={allShopping} columns={columns} pagination={false} size="small" />
        </Panel>
      </Collapse>
