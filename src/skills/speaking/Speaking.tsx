  ...
  return (
    <div>
      <ol className='a1'>
        ...
        <p style={{ marginTop: '1rem' }}>
          Лучшим решением будет в начале изучить все диалоги уровня А1, а затем вернутся в начало и изучить все диалоги уровня А2. Для уровня B1 будет иной
          способ улучшения говорения (пока в разработке)
        </p>
      </ol>

      <ul>
        Источник вдохновение №1 -
        <span style={{ marginLeft: '4px' }}>
          <a
            href='https://rushengl.com/read.php?level=3&type=3'
            target='_blank'
          >
            Beginner
          </a>
        ...
        <span style={{ marginLeft: '4px' }}>
          <a
            href='https://rushengl.com/read.php?level=4&type=3'
            target='_blank'
          >
            Elementary
          </a>
        ...
        <span style={{ marginLeft: '4px' }}>
          <a
            href='https://rushengl.com/read.php?level=5&type=3'
            target='_blank'
          >
            Pre-intermediate
          </a>
        ...
        <span style={{ marginLeft: '4px' }}>
          <a
            href='https://rushengl.com/read.php?level=6&type=3'
            target='_blank'
          >
            Pre-intermediate +
          </a>
