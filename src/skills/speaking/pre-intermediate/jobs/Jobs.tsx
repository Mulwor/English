...
export const JobsAndProfessions = () => {
  ...
  return (
    <>
      ...
      <p>
        Цель этого топика - научится называть профессию и уметь сказать где работают эти люди; уметь описать простые обязанности (Daily routines) через always,
        usually, sometimes; объяснить, почему нравится или не нравится работа (Opinions & Adjectives) - уметь использовать простые прилагательные для выражения
        мнения. Уметь строить вопросы и рассказывать о своих планах и мечтах на будущее ~ want to be, would like to be
      </p>
