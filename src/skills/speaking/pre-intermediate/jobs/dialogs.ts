// Dialogue 1: Talking About Your Job (Разговор о своей работе)
// Characters: Two people, Anna and David, meeting at a party

// Anna: So, David, what do you do for a living?
// David: I'm a teacher. I teach history at a high school.
// Anna: That's interesting! Do you enjoy it?
// David: Most days, yes. The students can be challenging sometimes, but I love history.
// Anna: How long have you been teaching?
// David: About five years now. What about you? What do you do?
// Anna: I'm a graphic designer. I work for a small design agency.
// David: That sounds creative. Do you work in an office or from home?
// Anna: Both, actually. I go to the office three days a week and work from home two days.
// David: That's a nice balance. I have to be at school every day. 8 to 4.
// Anna: That's a long day. But you get summers off, right?
// David: Yes, that's the best part! Two months of vacation. It's great.
// Anna: I'm a little jealous. I only get four weeks.
// David: But you have more flexibility during the year. Every job has pros and cons.
// Anna: True. Well, nice to meet you, David. Maybe we can chat more later.
// David: Nice to meet you too, Anna!

// Dialogue 2: Choosing a Career (Выбор карьеры)
// Characters: Two friends, Emma and Lucy, talking about the future

// Emma: Lucy, I have no idea what I want to do after university. It's so stressful.
// Lucy: I know what you mean. There are so many choices. What subjects do you like?
// Emma: I like working with people. Maybe something in healthcare?
// Lucy: Like a doctor or nurse?
// Emma: Doctor is too much study. Maybe nurse? Or physiotherapist?
// Lucy: Both are good jobs. You help people and the pay is decent.
// Emma: What about you? What do you want to do?
// Lucy: I want to work in business. Maybe marketing or human resources.
// Emma: That suits you. You're very organized and good with people.
// Lucy: Thanks. I'm also considering journalism. I love writing.
// Emma: Journalism is competitive, though. Hard to find jobs.
// Lucy: I know. That's why I'm not sure. What about teaching?
// Emma: I thought about it. But teenagers scare me!
// Lucy: Haha, fair enough. My cousin is a teacher. She says it's rewarding but exhausting.
// Emma: I need to do more research. Talk to people in different jobs.
// Lucy: Good idea. Let's make a list and interview people we know.
// Emma: That's smart! We can learn from their experiences.

// Dialogue 3: First Day at Work (Первый день на работе)
// Characters: New employee (Sarah) and her colleague (Mike)

// Mike: You must be Sarah! Welcome to the team. I'm Mike.
// Sarah: Hi Mike! Yes, I'm Sarah. It's nice to meet you. This is my first day.
// Mike: How are you feeling? Nervous?
// Sarah: A little, yes. New job, new people... it's a lot.
// Mike: Don't worry. Everyone here is very friendly. Let me show you around.
// Sarah: That would be great, thank you!
// Mike: This is your desk. We set up your computer already. Do you need anything?
// Sarah: It looks perfect. Where's the coffee machine?
// Mike: I'll show you. It's in the break room, right over there. Also, there's a kitchen with a fridge.
// Sarah: Great. And where's the bathroom?
// Mike: Down the hall, on the left. It's marked.
// Sarah: Thanks. What time is lunch usually?
// Mike: Most people eat between 12 and 2. There's a good cafeteria on the first floor.
// Sarah: Perfect. And who should I ask if I have questions about work?
// Mike: You can ask me, or your manager, Lisa. She's in the office next to yours.
// Sarah: Got it. Thanks so much, Mike. You're very helpful.
// Mike: No problem! We were all new once. Let's grab coffee and I'll introduce you to everyone.

// Dialogue 4: Job Interview (Собеседование)
// Characters: Interviewer (Mr. Brown) and Candidate (Anna)

// Mr. Brown: Good morning, Anna. Please, have a seat.
// Anna: Good morning. Thank you for seeing me.
// Mr. Brown: So, tell me a little about yourself. Why are you interested in this job?
// Anna: I've always been interested in marketing. I love creating campaigns and connecting with people.
// Mr. Brown: That's good to hear. Do you have any experience in this field?
// Anna: Yes, I did an internship at a marketing agency for six months. I learned a lot there.
// Mr. Brown: What kind of tasks did you do?
// Anna: I helped with social media, wrote content for the website, and assisted with events.
// Mr. Brown: That sounds relevant. What are your strengths?
// Anna: I'm very organized and creative. I work well in a team and I'm always eager to learn.
// Mr. Brown: And your weaknesses?
// Anna: Sometimes I'm a perfectionist. I spend too much time making things perfect.
// Mr. Brown: That's not a bad weakness to have. Where do you see yourself in five years?
// Anna: I hope to grow in this company and take on more responsibility. Maybe lead my own projects.
// Mr. Brown: Great. Do you have any questions for me?
// Anna: Yes, what's the team like? How many people would I work with?
// Mr. Brown: You'd be part of a team of six. Very collaborative and supportive.
// Anna: That sounds wonderful. Thank you for your time.
// Mr. Brown: Thank you, Anna. We'll be in touch soon.

// Dialogue 5: Different Professions (Разные профессии)
// Characters: Two friends, Tom and Lisa, talking about their family members

// Tom: What does your dad do, Lisa?
// Lisa: He's a doctor. A surgeon, actually. He works at the city hospital.
// Tom: Wow, that's impressive. Long hours, I imagine?
// Lisa: Yes, very long. Sometimes he's on call at night. But he loves his job.
// Tom: My mom is a nurse. She works at the same hospital, maybe they know each other!
// Lisa: Really? What's her name?
// Tom: Margaret. She works in the children's ward.
// Lisa: I'll ask my dad! That would be funny if they work together.
// Tom: What about your mom? What does she do?
// Lisa: She's a teacher. Elementary school. She teaches 7-year-olds.
// Tom: That takes patience! Little kids are so energetic.
// Lisa: She loves it. Says every day is different. My brother is a chef.
// Tom: A chef? That's cool. Where does he work?
// Lisa: At a fancy restaurant in the city center. Italian food.
// Tom: I love Italian! Maybe I'll go there sometime.
// Lisa: You should! Tell him Lisa sent you. He might give you a discount!
// Tom: Haha, deal! My family is less exciting. My dad is an accountant. Boring but stable.
// Lisa: Nothing wrong with stable! Every job is important.

// Dialogue 6: Working from Home (Работа из дома)
// Characters: Two colleagues, Rachel and Ben, on a video call

// Rachel: Ben, can you hear me okay? Your video is a little frozen.
// Ben: Sorry, my internet is slow today. Let me turn off my video. Better?
// Rachel: Yes, audio is clear now. How's working from home going?
// Ben: It has its pros and cons. I save time on commuting, but I miss talking to people.
// Rachel: Same. I love being in my pajamas, but I get lonely sometimes.
// Ben: Do you have a good workspace at home?
// Rachel: I set up a desk in my bedroom. It's small but works. You?
// Ben: I use the kitchen table. Not ideal, but it's okay. My back hurts sometimes.
// Rachel: You should get a better chair. Your back is important.
// Ben: I know. I've been looking online. Any recommendations?
// Rachel: I got mine from IKEA. It was €100 and very comfortable.
// Ben: Thanks, I'll check it out. How do you stay focused at home?
// Rachel: I make a schedule. Start at 9, lunch at 1, finish at 5. And I take short breaks.
// Ben: Good idea. I get distracted by the TV. Or the fridge!
// Rachel: Haha, same. The fridge calls my name all day.
// Ben: Okay, let's get back to work. Talk later!

// Dialogue 7: Asking for a Raise (Просьба о повышении)
// Characters: Employee (Mark) and Manager (Mrs. Davis)

// Mark: Mrs. Davis, do you have a moment? I'd like to talk to you about something.
// Mrs. Davis: Of course, Mark. Come in and close the door. What's on your mind?
// Mark: I've been working here for three years now. And I really enjoy my job.
// Mrs. Davis: That's good to hear. You're a valuable member of the team.
// Mark: Thank you. I wanted to discuss the possibility of a salary increase.
// Mrs. Davis: I see. What makes you feel you deserve a raise?
// Mark: I've taken on more responsibilities in the last year. I'm also training new employees now.
// Mrs. Davis: That's true. You've been doing excellent work.
// Mark: Thank you. I've also completed two professional development courses on my own time.
// Mrs. Davis: I didn't know that. Which courses?
// Mark: Project management and advanced Excel. I use both skills every day now.
// Mrs. Davis: That's impressive. Let me review your file and talk to HR. Can we discuss this next week?
// Mark: Of course. Thank you for listening.
// Mrs. Davis: You're welcome. I appreciate you bringing this to my attention.
// Mark: Have a good day, Mrs. Davis.
// Mrs. Davis: You too, Mark.

// Dialogue 8: Quitting a Job (Увольнение с работы)
// Characters: Employee (Anna) and Manager (Mr. Wilson)

// Anna: Mr. Wilson, do you have a minute? I need to talk to you.
// Mr. Wilson: Sure, Anna. Come in. What's going on?
// Anna: This is difficult for me to say, but I'm handing in my resignation.
// Mr. Wilson: Oh, I'm sorry to hear that. Can I ask why?
// Anna: I've been offered a position at another company. It's a great opportunity for my career.
// Mr. Wilson: I understand. We'll be sad to lose you. When is your last day?
// Anna: I can stay for two more weeks. I want to finish my current projects.
// Mr. Wilson: That's very professional of you. Thank you.
// Anna: I've really enjoyed working here. I've learned so much.
// Mr. Wilson: You've been a great employee. We'll miss you. Where will you be working?
// Anna: At a marketing agency in the city. It's a step up for me.
// Mr. Wilson: Good for you. I'm happy for you, even though I'm sad to see you go.
// Anna: Thank you for everything, Mr. Wilson. You've been a great manager.
// Mr. Wilson: You're welcome. Let's work on a transition plan for the next two weeks.
// Anna: Sounds good. I'll make a list of everything I'm working on.
// Mr. Wilson: Perfect. And keep in touch. Let us know how you're doing.

// Dialogue 9: Different Workplaces (Разные места работы)
// Characters: Two friends, Emma and David, talking about where they work

// Emma: So, David, where do you work exactly?
// David: I work in a hospital. I'm a lab technician. I analyze blood samples.
// Emma: That sounds very scientific. Is it a big hospital?
// David: Pretty big. About 500 beds. There's a big team of doctors and nurses.
// Emma: Do you like the environment? Hospitals can be stressful.
// David: Sometimes, yes. But I'm in the lab, away from patients. It's quiet.
// Emma: That's good. I work in a school. I'm a secretary in the main office.
// David: That must be busy. Lots of parents and students?
// Emma: Very busy! Phones ringing, people coming in, questions all day.
// David: Do you enjoy it?
// Emma: I do. I like helping people. And I love the school atmosphere. It's energetic.
// David: Better than a quiet lab sometimes! What about your husband? Where does he work?
// Emma: He works in a factory. He operates machines that make car parts.
// David: That's completely different. Factory work is hard physically.
// Emma: Yes, he comes home tired every day. But the pay is good.
// David: Every workplace has its challenges. The office, the hospital, the factory...
// Emma: True. As long as you like what you do, that's what matters.

// Dialogue 10: Part-Time Jobs (Подработка для студентов)
// Characters: Two students, Mike and Sarah, talking about work

// Mike: Sarah, do you have a part-time job? I'm looking for one.
// Sarah: Yes, I work at a coffee shop near campus. Three days a week.
// Mike: That's cool! Do you like it?
// Sarah: It's okay. The pay is minimum wage, but tips are good. And free coffee!
// Mike: Free coffee is a big plus! How many hours do you work?
// Sarah: About 15 hours a week. It's perfect for a student. Not too much.
// Mike: Do they work with your class schedule?
// Sarah: Yes, I give them my availability each week. They're very flexible.
// Mike: That sounds ideal. Are they hiring?
// Sarah: I think so! I saw a sign on the door. "Barista wanted."
// Mike: Really? I have no experience making coffee.
// Sarah: They train you. I had no experience either. It's easy to learn.
// Mike: What's the manager like?
// Sarah: She's nice. A little strict about being on time, but fair.
// Mike: Okay, I'll go apply tomorrow. Thanks for the tip!
// Sarah: No problem! Maybe we can work together. It's fun when it's busy.
// Mike: That would be great. Free coffee and a friend? Perfect student job!

// Dialogue 11: Dream Job (Работа мечты)
// Characters: Two friends, Anna and Tom, talking about their dreams

// Anna: Tom, if you could do any job in the world, what would it be?
// Tom: That's a hard question! Probably a pilot. I'd love to fly planes and see the world.
// Anna: A pilot? That's cool! Why don't you do it?
// Tom: Training is expensive and takes years. Maybe one day. What about you?
// Anna: I'd love to be a writer. Travel the world and write books about my adventures.
// Tom: That sounds perfect for you. You're always writing in that notebook.
// Anna: It's my dream. But writing doesn't pay well, especially at the start.
// Tom: True. My cousin is a writer. She works as a waitress too, to pay the bills.
// Anna: That's what I'm afraid of. I want a stable job that I also enjoy.
// Tom: Maybe you can do both. Write in your free time, work during the day.
// Anna: That's the plan. What about being a photographer? You take amazing photos.
// Tom: Thanks! I've thought about it. But as a hobby, not a job. I don't want to hate it.
// Anna: Good point. Sometimes making your hobby a job ruins it.
// Tom: Exactly. So I'll keep it as a passion and find a job I like enough.
// Anna: Sensible. But never stop dreaming!

// Dialogue 12: Retiring (Выход на пенсию)
// Characters: Two colleagues, Margaret and John, at an office party

// Margaret: John, I can't believe you're retiring! After 40 years at this company.
// John: I know. It feels strange. But it's time. I want to relax and enjoy life.
// Margaret: What will you do with all your free time?
// John: So many things! Travel, garden, spend time with my grandchildren.
// Margaret: That sounds wonderful. You deserve it. Any travel plans?
// John: First, a road trip across the country with my wife. Then maybe Europe.
// Margaret: Europe! How exciting. I'm a little jealous.
// John: You should visit when you retire. It's beautiful.
// Margaret: I have 15 more years. But I'll keep that in mind.
// John: Time flies. It feels like yesterday I started here. Young and nervous.
// Margaret: And now you're the boss! Well, almost.
// John: Haha, yes. It's been a good career. I'll miss the people most.
// Margaret: We'll miss you too. Who's going to tell the best jokes in the office?
// John: That's your job now! You have to carry on the tradition.
// Margaret: No pressure! We should have a party for you. A real goodbye.
// John: You don't have to do that.
// Margaret: We want to. You deserve a great send-off.
// John: Thank you, Margaret. That means a lot.

// Dialogue 13: Unusual Jobs (Необычные профессии)
// Characters: Two friends, Lisa and Mark, watching TV

// Lisa: Mark, look at this show. It's about unusual jobs. So interesting!
// Mark: What kind of jobs?
// Lisa: This one is about a food taster. Someone who tastes chocolate all day!
// Mark: That's a job? I want that job! Eating chocolate and getting paid.
// Lisa: I know, right? But you can't eat too much. Just a little bite each time.
// Mark: Still, better than my job. What else?
// Lisa: There's a professional sleeper. People pay you to test mattresses and hotels.
// Mark: Sleeping for money? That's crazy! Where do I apply?
// Lisa: Haha, I know. And here's a pet food tester. People who taste dog food!
// Mark: Okay, that's gross. I don't want that job.
// Lisa: Me neither. But they check the quality and taste for dogs.
// Mark: Dogs don't care about taste! They eat anything.
// Lisa: True. Oh, and here's a professional cuddler. You cuddle with people for money.
// Mark: That's weird. I wouldn't want to cuddle strangers.
// Lisa: Same. Some jobs are really unusual. What's the strangest job you've heard of?
// Mark: Golf ball diver. People who dive into lakes at golf courses to find lost balls.
// Lisa: Really? That's a job?
// Mark: Yes! They sell the balls. Some make good money.
// Lisa: People will do anything for money! But I'll stick with my office job.

// Dialogue 14: Working Overtime (Сверхурочная работа)
// Characters: Two colleagues, Rachel and David, at the office late

// Rachel: David, it's 7 PM. Why are you still here?
// David: I have so much work. The deadline is Friday and I'm behind.
// Rachel: You've been here since 8 AM. That's 11 hours!
// David: I know. But I need to finish this report. My boss is stressed about it.
// Rachel: Don't you have to pick up your kids?
// David: My wife is getting them today. She's not happy about it.
// Rachel: I can imagine. Overtime is hard on families.
// David: It is. But sometimes you have to do it. How about you? Why are you here late?
// Rachel: I'm waiting for a client call. Different time zone. They're in New York.
// David: Oh, the joys of international business. What time is the call?
// Rachel: 8 PM their time, which is 2 AM here. Just kidding, it's 8 PM here.
// David: Haha, you scared me. 2 AM is crazy.
// Rachel: I've done it before. Not fun. Do you get overtime pay?
// David: No, I'm salaried. So extra hours are just... extra.
// Rachel: That's not fair. You should get something.
// David: Welcome to the corporate world. Okay, I need coffee. Want some?
// Rachel: Yes, please. Let's survive this night together.
// David: Deal. Coffee and complaining. The perfect combination.

// Dialogue 15: Changing Careers (Смена карьеры)
// Characters: Two friends, Emma and James, at a cafe

// Emma: James, I'm thinking about changing careers. I'm so unhappy in my job.
// James: Really? I thought you liked accounting.
// Emma: I thought so too. But every day is the same. Numbers, spreadsheets, no creativity.
// James: That sounds boring. What would you rather do?
// Emma: I want to work with animals. Maybe become a vet technician.
// James: That's a big change! From numbers to animals. What made you decide?
// Emma: I volunteer at an animal shelter on weekends. I love it. It feels meaningful.
// James: That's wonderful. But vet tech requires training, right?
// Emma: Yes, a two-year program. I'm scared to go back to school at my age.
// James: You're not old! People change careers all the time. My mom did at 50.
// Emma: Really? What did she do?
// James: She was a bank manager. Now she's a yoga teacher. Much happier.
// Emma: That's inspiring. How did she afford to study?
// James: She saved money and did night classes. It took time, but she did it.
// Emma: Maybe I can do that. Keep my job and study at night.
// James: It will be hard, but worth it if it makes you happy.
// Emma: You're right. Life is too short to be miserable at work.
// James: Exactly. Follow your passion. The money will follow.
// Emma: Thanks, James. You've given me courage. I'm going to look into programs this week.
// James: Good for you! Let me know how it goes. I'm cheering for you!
