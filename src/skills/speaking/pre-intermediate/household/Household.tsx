...
export const HouseholdObjects = () => {
  ...
  return (
    <>
      ...
      <p>
        Цель этого топика - научиться рассказывать о своём доме (мебель), описывать его комнаты и предметы, говорить о местонахождении предметов, описывать о
        каком дом мечтаешь. И уметь спрашивать и отвечать о домашних делах (Household chores) - "I clean my room every Saturday." "Do you wash the dishes?" "She
        vacuums the carpet."
      </p>
