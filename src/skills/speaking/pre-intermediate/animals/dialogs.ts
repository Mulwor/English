...
export const animal_01 = [
  {
    key: '1',
    english: 'Look, Tom! The lions are sleeping.',
    russian: 'Смотри, Том! Львы спят.'
  },
  {
    key: '2',
    english: 'Oh yes! They are so big and beautiful. Are they dangerous?',
    russian: 'О да! Они такие большие и красивые. Они опасны?'
  },
  {
    key: '3',
    english: 'Yes, they are. They are wild animals. But they look very tired and lazy right now.',
    russian: 'Да. Это дикие животные. Но сейчас они выглядят очень уставшими и ленивыми.'
  },
  {
    key: '4',
    english: 'You\'re right. They probably eat a lot of meat. What\'s that animal over there? It has a very long neck.',
    russian: 'Ты прав. Они, наверное, едят много мяса. Что это за животное вон там? У него очень длинная шея.'
  },
  {
    key: '5',
    english: 'That\'s a giraffe. Giraffes are my favourite. They are so tall and gentle.',
    russian: 'Это жираф. Жирафы — мои любимчики. Они такие высокие и нежные.'
  },
  {
    key: '6',
    english: 'They are beautiful. Look, it\'s eating leaves from that tall tree. Can we buy some food for them?',
    russian: 'Они красивые. Смотри, он ест листья с того высокого дерева. Можем мы купить для них еды?'
  },
  {
    key: '7',
    english: 'No, we can\'t. The sign says "Don\'t feed the animals." It\'s not good for them.',
    russian: 'Нет, нельзя. На табличке написано: «Не кормите животных». Это вредно для них.'
  },
  {
    key: '8',
    english: 'Okay. Let\'s go and see the elephants next. I love their big ears.',
    russian: 'Хорошо. Тогда пойдем смотреть слонов. Я люблю их большие уши.'
  },
  {
    key: '9',
...
export const animal_03 = [
  {
    key: '1',
    english: "Wow, You have so many animals. It's so noisy here!",
    russian: "Ничего себе, у вас так много животных. Здесь так шумно!"
  },
  {
    key: '2',
    english: "Yes, we have cows, sheep, and chickens. And there is a new horse.",
    russian: "Да, у нас есть коровы, овцы и куры. И еще есть новая лошадь."
  },
  {
    key: '3',
    english: "I love the little lambs! They are so soft and white. Can I touch one?",
    russian: "Я люблю маленьких ягнят! Они такие мягкие и белые. Можно погладить одного?"
  },
  {
    key: '4',
    english: "Sure, but be very gentle. They are babies. Their mum is over there, watching us.",
    russian: "Конечно, но будь очень нежен. Они малыши. Их мама вон там, смотрит на нас."
  },
  {
    key: '5',
    english: "What sound do the cows make? I can hear a loud noise.",
    russian: "Какие звуки издают коровы? Я слышу громкий шум."
  },
  {
    key: '6',
    english: "They go 'Moo!' when they are hungry. Can you hear them? It's time for their food.",
    russian: "Они говорят 'My!' когда голодны. Слышишь их? Время их кормления."
  },
  {
    key: '7',
    english: "And the chickens? Do you get eggs from them every day?",
    russian: "А куры? Ты собираешь яйца каждый день?"
  },
  {
    key: '8',
    english: "Yes! Every morning I go to the chicken coop. There are always fresh eggs. Do you want to help me collect the eggs later?",
    russian: "Да! Каждое утро я хожу в курятник. Там всегда свежие яйца. Хочешь помочь мне собрать яйца позже?"
  },
  {
    key: '9',
    english: "Yes, please! I love fresh eggs for breakfast. And after that, can we see the new horse?",
    russian: "Да, с удовольствием! Я люблю свежие яйца на завтрак. А после этого можно посмотреть новую лошадь?"
  },
  {
    key: '10',
...
export const animal_05 = [
  {
    key: '1',
    english: "Hey, Clara. How is your new cat? Is she adapting well?",
    russian: "Привет, Клара. Как твоя новая кошка? Она хорошо адаптируется?"
  },
  {
    key: '2',
    english: "She's crazy! But we love her so much. Yesterday, she did something very funny.",
    russian: "Она сумасшедшая! Но мы ее очень любим. Вчера она сделала кое-что очень забавное."
  },
  {
    key: '3',
    english: "Really? Tell me! What did she do?",
    russian: "Правда? Расскажи! Что она сделала?"
  },
  {
    key: '4',
    english: "She saw a fly on the window. She sat there and watched it for a long time. Then she tried to catch it and... bang! She fell off the sofa!",
    russian: "Она увидела муху на окне. Сидела там и долго за ней наблюдала. Потом попыталась поймать и... бах! Упала с дивана!"
  },
  {
    key: '5',
    english: "Oh no! Is she okay? Did she hurt herself?",
    russian: "О нет! С ней все в порядке? Она ушиблась?"
  },
  {
    key: '6',
    english: "Yes, she's fine. She just landed on her feet, like cats do. But she looked very surprised. Her eyes were so big! Then she ran away and hid under the bed.",
    russian: "Да, все хорошо. Она приземлилась на лапы, как все кошки. Но выглядела очень удивленной. Глаза были такие большие! Потом убежала и спряталась под кроватью."
  },
  {
    key: '7',
    english: "Haha, silly cat. She was probably embarrassed. Cats are so funny and have so much personality.",
    russian: "Ха-ха, глупая кошка. Наверное, ей было стыдно. Кошки такие забавные и с таким характером."
  },
  {
    key: '8',
...
export const animal_07 = [
  ...
  {
    key: '7',
    english: "Really? Was he okay?",
    russian: "Правда? С ним все было в порядке?"
  },
  {
    key: '8',
    english: "He looked fine. Just walking slowly. Do you have a photo?",
    russian: "Он выглядел нормально. Просто медленно гулял. У тебя есть фото?"
  },
  {
    key: '9',
    english: "Yes, here on my phone. This is Oliver.",
    russian: "Да, вот на телефоне. Это Оливер."
  },
  {
    key: '10',
...
export const animal_09 = [
  {
    ...
    russian: "Кейт, что это за животное? Оно большое и серое."
  },
  {
    key: '2',
    english: "That's an elephant. In English, we say 'elephant'.",
    russian: "Это слон. По-английски мы говорим 'elephant'."
  },
  {
    key: '3',
  ...
  {
    key: '5',
    english: "That's silly! And what about this one? It has a long tail and it climbs trees.",
    russian: "Это глупо! А как насчет этого? У него длинный хвост, и он лазает по деревьям."
  },
  {
    key: '6',
    english: "That's a monkey. Monkeys say 'Ooh ooh ah ah'!",
    russian: "Это обезьяна. Обезьяны говорят 'У-у-у, а-а-а'!"
  },
  {
    key: '7',
    english: "Ooh ooh ah ah! I can do that! And what sound does a frog make in English?",
    russian: "У-у-у, а-а-а! Я так могу! А какой звук издает лягушка по-английски?"
  },
  {
    key: '8',
    english: "Frogs say 'Ribbit ribbit'. Not 'kva-kva' like in our language.",
    russian: "Лягушки говорят 'Рибит-рибит'. А не 'ква-ква', как в нашем языке."
  },
  {
    key: '9',
    english: "This is so fun! Let's do all the animals!",
    russian: "Это так весело! Давай всех животных!"
  },
  {
    key: '10',
    english: "Okay, but this is the last one. What's your favorite animal sound?",
    russian: "Хорошо, но это последний. Какой звук животного твой любимый?"
  },
  {
    key: '11',
...
export const animal_11 = [
  ...
  {
    key: '6',
    english: "Yes, but a dog is more expensive too. Food, toys, the vet...",
    russian: "Да, но собака ещё и дороже. Еда, игрушки, ветеринар..."
  },
  {
    key: '7',
    english: "I never thought about that. Is your dog friendlier than other dogs?",
    russian: "Я никогда об этом не думал. Твоя собака дружелюбнее других собак?"
  },
  {
    key: '8',
    english: "He's friendly with people, but he's bigger than most dogs. Sometimes he doesn't know his own strength!",
    russian: "Он дружелюбен с людьми, но он больше, чем большинство собак. Иногда он не знает своей силы!"
  },
  {
    key: '9',
...
export const animal_13 = [
  {
    ...
    russian: "Эй, Сэм, это правда, что у тебя есть домашняя змея?"
  },
  {
    key: '2',
  ...
  {
    key: '5',
    english: "Frozen mice? That's disgusting! My mom would never let me have a snake.",
    russian: "Замороженные мыши? Это отвратительно! Моя мама ни за что не разрешила бы мне завести змею."
  },
  {
    key: '6',
    english: "My mom said no at first too. But snakes are very quiet and clean. They don't smell.",
    russian: "Моя мама сначала тоже сказала нет. Но змеи очень тихие и чистые. От них не пахнет."
  },
  {
    key: '7',
    english: "That's true. My dog smells bad sometimes. Can I hold Monty sometime?",
    russian: "Это правда. Моя собака иногда плохо пахнет. Можно мне как-нибудь подержать Монти?"
  },
  {
    key: '8',
    english: "Sure! He's very calm. But you have to wash your hands first. Snakes can get sick from our soap.",
    russian: "Конечно! Он очень спокойный. Но сначала надо помыть руки. Змеи могут заболеть от нашего мыла."
  },
  {
    key: '9',
...
export const animal_15 = [
  {
    ...
    russian: "Итак, для нашего проекта я подумала, мы могли бы рассказать о пандах."
  },
  {
    key: '2',
    english: "Good idea. But why pandas? There are many animals.",
    russian: "Хорошая идея. Но почему панды? Есть много животных."
  },
  {
    key: '3',
    english: "Because they are in danger. There aren't many left in the wild.",
    russian: "Потому что они в опасности. В дикой природе их осталось мало."
  },
  {
    key: '4',
    english: "Oh, that's sad. Why are they in danger?",
    russian: "О, это печально. Почему они в опасности?"
  },
  {
    key: '5',
    english: "People cut down forests where they live. They don't have enough bamboo to eat.",
    russian: "Люди вырубают леса, где они живут. Им не хватает бамбука для еды."
  },
  {
    key: '6',
    english: "That's terrible. What about tigers? I saw on TV that they are in danger too.",
    russian: "Это ужасно. А тигры? Я видел по телевизору, что они тоже в опасности."
  },
  {
    key: '7',
    english: "Yes, because some people hunt them for their fur. It's really bad.",
    russian: "Да, потому что некоторые люди охотятся на них из-за их меха. Это очень плохо."
  },
  {
    key: '8',
    english: "We need to tell our class about this. Maybe we can help somehow.",
    russian: "Нам нужно рассказать об этом нашему классу. Может, мы сможем как-то помочь."
  },
  {
    key: '9',
    english: "We can put information in our project about how to protect them.",
    russian: "Мы можем включить в наш проект информацию о том, как их защитить."
  },
  {
    key: '10',
    english: "Good idea. Like 'don't buy things from animals' and 'help save the forests'.",
    russian: "Хорошая идея. Например, 'не покупайте вещи из животных' и 'помогите спасти леса'."
  },
  {
    key: '11',
    english: "Exactly! Let's make a poster with pictures of pandas and tigers.",
