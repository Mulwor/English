// Dialogue 1: Morning Commute (Утренняя дорога на работу)
// Characters: Two colleagues, Anna and David, at the office

// Anna: David, you look tired. Rough morning?
// David: So tired. My commute was terrible today. Two hours!
// Anna: Two hours? That's crazy! What happened?
// David: First, the train was delayed 20 minutes. Then it was so crowded, no seats.
// Anna: I hate when that happens. Standing for a long time is exhausting.
// David: Then I had to change trains, and the connection was late too. So I waited another 15 minutes.
// Anna: Oh no! And then?
// David: Then the bus to the office was stuck in traffic. It took forever.
// Anna: What a nightmare! How do you usually get to work?
// David: Train and bus. About an hour normally. Today was twice that.
// Anna: That's still a long commute. Mine is only 20 minutes by bike.
// David: You're so lucky! Biking is faster and you get exercise.
// Anna: True, but when it rains, I get wet. Not so fun.
// David: I'd take rain over delays any day. Maybe I should move closer to work.
// Anna: Or get a bike! It's cheaper than moving.
// David: Haha, true. I'll think about it. For now, I need coffee. Lots of coffee.
// Anna: Go get some. You deserve it after that morning!

// Dialogue 2: Buying a Train Ticket (Покупка билета на поезд)
// Characters: Passenger and Ticket Clerk at a train station

// Clerk: Good morning. How can I help you today?
// Passenger: Hello. I need a ticket to Manchester, please.
// Clerk: Certainly. When would you like to travel?
// Passenger: This Friday, in the morning. Around 9 or 10.
// Clerk: Let me check... There's a train at 9:15 and another at 10:30.
// Passenger: The 9:15 sounds good. How long is the journey?
// Clerk: About two hours and fifteen minutes.
// Passenger: That's fine. How much is a return ticket?
// Clerk: A return is £45. Single is £28. Coming back on Sunday?
// Passenger: Yes, Sunday afternoon. Around 4 or 5.
// Clerk: There's a train at 4:45. That gives you a full day.
// Passenger: Perfect. I'll take the return ticket.
// Clerk: Great. That's £45 please. Cash or card?
// Passenger: Card, please. Pays Do I need to reserve a seat?
// Clerk: It's not required, but I can reserve one for you. Window or aisle?
// Passenger: Window, please. I like to look out.
// Clerk: Done. Here's your ticket. Platform 3 for the 9:15. Have a good trip!
// Passenger: Thank you very much!

// Dialogue 3: On the Bus (В автобусе)
// Characters: Two passengers, Emma and an elderly woman, sitting next to each other

// Elderly Woman: Excuse me, young lady. Does this bus go to the city center?
// Emma: Yes, it does. We're going that way now. About 15 more minutes.
// Elderly Woman: Thank you. I'm not from here. Visiting my daughter.
// Emma: That's nice! Which stop do you need?
// Elderly Woman: The one near the big library. I think it's called Central Station?
// Emma: Oh yes, that's the next stop after mine. I'll tell you when we get there.
// Elderly Woman: Would you? That's so kind. My eyes aren't what they used to be.
// Emma: Of course. It's no problem. Do you visit often?
// Elderly Woman: Twice a year. My daughter moved here five years ago.
// Emma: That's lovely. My mom lives far away too. I miss her.
// Elderly Woman: You should call her. Mothers love hearing from their children.
// Emma: I will. Thank you. Oh, here comes my stop. Yours is the next one.
// Elderly Woman: Thank you, dear. You have a beautiful day.
// Emma: You too! Enjoy your visit with your daughter!
// Elderly Woman: I will. Goodbye!
// Emma: Bye! Gets off

// Dialogue 4: Calling a Taxi (Вызов такси)
// Characters: Customer and Dispatcher on the phone

// Dispatcher: City Taxi. How can I help you?
// Customer: Hello. I'd like to book a taxi, please.
// Dispatcher: Certainly. Where are you calling from?
// Customer: 45 Park Avenue. The corner of Park and Main.
// Dispatcher: Got it. And where are you going?
// Customer: To the airport. Terminal 2.
// Dispatcher: When do you need the taxi?
// Customer: As soon as possible, please. My flight is in two hours.
// Dispatcher: I have a car nearby. Should be there in 5-7 minutes.
// Customer: Perfect! How will I recognize it?
// Dispatcher: It's a blue sedan. License plate starts with TX 123.
// Customer: Great. And how much will it cost to the airport?
// Dispatcher: About £25-30, depending on traffic.
// Customer: That's fine. Do you accept card?
// Dispatcher: Yes, the driver has a card machine. Or you can pay cash.
// Customer: Card is fine. Thank you so much.
// Dispatcher: You're welcome. The driver will call if there are any issues. Have a good flight!
// Customer: Thank you. Goodbye.

// Dialogue 5: At the Airport Check-in (Регистрация в аэропорту)
// Characters: Passenger and Check-in Agent

// Agent: Good afternoon. Passport and ticket, please.
// Passenger: Here you go. I'm flying to Barcelona.
// Agent: Thank you. Are you checking any bags today?
// Passenger: Yes, one suitcase. Puts it on scale
// Agent: 22 kilos. That's fine. The limit is 23. Any carry-on?
// Passenger: Just this backpack. It fits under the seat.
// Agent: Perfect. Would you like a window or aisle seat?
// Passenger: Aisle, please. I like to get up easily.
// Agent: Aisle it is. Row 14, seat C. Here's your boarding pass.
// Passenger: Thank you. What gate and what time?
// Agent: Gate 23. Boarding starts at 4:30. Your flight is at 5:15.
// Passenger: Got it. Is the gate far?
// Agent: About a 10-minute walk. Follow the signs. Plenty of time.
// Passenger: Great. Thank you very much.
// Agent: Enjoy your flight to Barcelona!
// Passenger: Thanks! I will!

// Dialogue 6: Getting a Driver's License (Получение водительских прав)
// Characters: Two friends, Mike and Sarah, after Mike's driving test

// Mike: Sarah! I passed! I finally passed my driving test!
// Sarah: Congratulations! Third time's the charm! How did it go?
// Mike: So much better than last time. I was nervous, but the instructor was nice.
// Sarah: What did you have to do?
// Mike: Parallel parking, three-point turn, and driving in traffic. All good!
// Sarah: No more problems with the parking?
// Mike: No! I practiced for hours. I can park perfectly now.
// Sarah: That's great! So when do you get your license?
// Mike: It comes in the mail in a week. But I can drive now! With a licensed driver next to me.
// Sarah: I'm licensed! Want to go for a drive?
// Mike: Really? You trust me?
// Sarah: You passed the test, right? Let's go! We can drive to the beach.
// Mike: That sounds amazing! But go easy on me. I'm still new.
// Sarah: Don't worry. I'll be the world's calmest passenger. No yelling, no grabbing the wheel.
// Mike: Haha, promise?
// Sarah: Promise. Let's do this! Road trip!
// Mike: I'm so excited. Freedom at last!

// Dialogue 7: Bike Sharing (Велопрокат)
// Characters: Two friends, Emma and Tom, in the city

// Emma: Tom, let's rent bikes! It's such a nice day.
// Tom: Great idea! But I haven't ridden a bike in years. I might be wobbly.
// Emma: It's like riding a bike! You never forget. Come on, it'll be fun.
// Tom: Okay, okay. How does this work? I've never used bike sharing before.
// Emma: See those blue bikes? Download the app, scan the QR code, and you're ready.
// *Tom: * Downloads app Okay, done. It says €2 for 30 minutes. Not bad.
// Emma: Yeah, cheap and good for the environment. Scan this one.
// Tom: Beep It's unlocked! Okay, here we go. Gets on Whoa, a little unstable.
// Emma: You're fine! Just relax. We'll go slow along the river.
// Tom: Okay, okay. This is actually fun! The wind in my hair...
// Emma: See? I told you! Let's go to the park. There's a bike path.
// Tom: Lead the way! This is so much better than the bus.
// Emma: And exercise too! Win-win.
// Tom: We should do this every weekend. Fresh air, exercise, and good company.
// Emma: Deal! But next time, you're buying the ice cream after.
// Tom: Haha, fair enough!

// Dialogue 8: Traffic Jam (Пробка на дороге)
// Characters: Two colleagues, Lisa and Mark, stuck in traffic

// Lisa: Ugh, look at this traffic. We haven't moved in 10 minutes.
// Mark: I know. This happens every Friday afternoon. Everyone is leaving for the weekend.
// Lisa: We should have left earlier. I have a dinner reservation at 7!
// Mark: What time is it now?
// Lisa: 6:30. And we're still 30 minutes away. I'm going to be late.
// Mark: Maybe the restaurant will hold the table. Call them.
// Lisa: Good idea. Calls Hello, I have a reservation at 7. I'm stuck in traffic. Can you hold it?
// Mark: Whisper What did they say?
// Lisa: They said 15 minutes late is okay. After that, they give the table away.
// Mark: 15 minutes. We can do that. Look, traffic is moving a little.
// Lisa: Finally! Come on, come on. I hate being late.
// Mark: Me too. But sometimes it's out of our control. At least the weather is nice.
// Lisa: True. And the music is good. What are we listening to?
// Mark: Some 90s playlist. Want me to change it?
// Lisa: No, I love 90s music! Okay, this isn't so bad. Traffic and good music.
// Mark: And good company. We'll get there. Don't stress.
// Lisa: You're right. Thanks, Mark. You're a good stress reducer.
// Mark: That's what colleagues are for!

// Dialogue 9: Asking for Directions (Спрашиваем дорогу)
// Characters: Tourist and Local Person on the street

// Tourist: Excuse me, sorry to bother you. I'm looking for the subway station.
// Local: No problem. Which line do you need?
// Tourist: The red line. I need to go to the museum.
// Local: Oh, the museum. The nearest station is two blocks away. Walk straight, then turn left.
// Tourist: Straight, then left. Got it. Is it far?
// Local: About 5 minutes. You'll see the sign. It's a big red M.
// Tourist: Perfect. And how do I buy a ticket?
// Local: There are machines inside. They take cash and cards. A single ride is €2.50.
// Tourist: Great. And which direction for the museum?
// Local: You want the northbound train. Platform 2. The museum is the third stop.
// Tourist: Third stop. Thank you so much! You've been very helpful.
// Local: My pleasure. Enjoy the museum. It's wonderful.
// Tourist: I will! Thanks again. Have a great day!
// Local: You too!

// Dialogue 10: Buying a Used Car (Покупка подержанного автомобиля)
// Characters: Two friends, James and Anna, looking at a car

// James: Anna, thanks for coming with me. I need a second opinion.
// Anna: No problem! I don't know much about cars, but I can look.
// James: The seller said it's in good condition. 2015 model, 80,000 miles.
// Anna: That's not too bad. How much is he asking?
// James: €8,000. Seems fair, but I want to negotiate.
// Anna: Always negotiate! Look at the tires first. They look a little worn.
// James: You're right. New tires cost money. I'll mention that.
// Anna: Check inside. Any smells? Stains?
// *James: * Opens door Smells fine. Seats look clean. No rips.
// Anna: Good. Start the engine. Listen for weird noises.
// James: Starts car Sounds okay to me. Smooth.
// Anna: Now test the lights, signals, air conditioning. Everything.
// James: Tests All working. AC is cold. Good.
// Anna: Take it for a test drive. Feel how it drives. Any vibrations?
// James: Drives around Feels smooth. Brakes are good. I like it.
// Anna: Then offer €7,000. Say the tires need replacing. See what he says.
// James: Great advice. You're a natural negotiator!
// Anna: Haha, I watch a lot of car shows. Let me know how it goes!
// James: Will do. Thanks, Anna. You're the best.

// Dialogue 11: Late for a Train (Опоздание на поезд)
// Characters: Two friends, Lucy and Mark, running through the station

// Lucy: Mark, hurry! The train leaves in 5 minutes!
// Mark: I'm running! This suitcase is so heavy. Why did I pack so much?
// Lucy: Because you always overpack! Come on, platform 7!
// Mark: Panting I see it! Platform 7, over there!
// Lucy: The doors are closing! Run!
// Mark: Wait! Wait! Jumps in just as doors close Made it!
// Lucy: Also inside, breathing hard Oh my god, that was close. My heart is racing.
// *Mark: * Mine too. I thought we were going to miss it.
// Lucy: We almost did! Next time, leave earlier. I told you!
// Mark: I know, I know. I'm sorry. I'm a terrible planner.
// Lucy: At least we made it. Now find our seats. I need to sit down.
// Mark: Checking tickets Seats 14A and 14B. This way.
// *Lucy: * Sits Ahh, that's better. Never running again.
// Mark: Until next time. You know me.
// Lucy: Haha, true. Okay, let's relax. We're on the train. Vacation starts now!
// Mark: Finally! Want to get snacks from the cafe car?
// Lucy: Yes! But you're buying. You almost made us miss the train.
// Mark: Fair enough. Deal!

// Dialogue 12: Taking the Subway (Метро)
// Characters: Two friends, Emma and David, figuring out the subway

// Emma: Okay, we need to get to the stadium. Which line?
// David: Let me look at the map. We're here, at Central Station. The stadium is... here.
// Emma: That looks like three stops. Blue line?
// David: Yes, blue line towards Westside. Get off at Sports Arena.
// Emma: Easy. Do we need to change trains?
// David: No, it's direct. Same line all the way. Perfect.
// Emma: How do we pay? Do we need a card?
// David: We can buy single tickets from the machine. Or get a day pass if we're using it a lot.
// Emma: Day pass might be cheaper. We'll take it back too, right?
// David: Yes, after the game. Let's get day passes. €8 each.
// *Emma: * Buys tickets Got them. Now which way?
// David: Follow the signs for blue line, westbound. Platform 2.
// Emma: This is so much easier than driving. No traffic, no parking.
// David: Exactly. Public transport is great in this city.
// Emma: Train is coming! Let's go!
// David: After you. Subway adventure begins!

// Dialogue 13: Ferry Ride (Поездка на пароме)
// Characters: Two tourists, Sarah and Tom, on a ferry

// Sarah: Tom, look at the view! It's amazing! The water is so blue.
// Tom: Wow, this is beautiful. I'm so glad we decided to take the ferry.
// Sarah: So much better than a crowded bus. Fresh air, sunshine...
// Tom: And we can stand outside. Feel the breeze. Perfect.
// Sarah: How long is the ride?
// Tom: About an hour to the island. Just enough time to relax.
// *Sarah: * I could do this all day. Just watching the water.
// Tom: Me too. Look, there are dolphins! Over there!
// *Sarah: * Where? Oh my god, I see them! Jumping! This is incredible!
// Tom: Best day ever. Dolphins on a ferry. Can't beat that.
// Sarah: I'm taking a million photos. My friends won't believe this.
// Tom: Neither will mine. This is why I love traveling. Surprises like this.
// Sarah: Want to get a drink from the cafe? They have coffee and snacks.
// Tom: Sure. Let's go. Then come back outside. I don't want to miss anything.
// Sarah: Agreed. This is the best transport ever. Why don't we have ferries at home?
// Tom: No water! We live in a landlocked city.
// *Sarah: * Oh right. Well, I'm enjoying it while I can!

// Dialogue 14: Scooter Rental (Аренда скутера)
// Characters: Two friends, Anna and Mike, at a scooter rental shop

// Anna: Mike, let's rent scooters! It's the best way to see the island.
// Mike: I've never ridden a scooter before. Is it hard?
// Anna: It's easy! Like a bike but with an engine. You'll learn in 5 minutes.
// Mike: I don't know... What if I crash?
// Anna: You won't crash. We'll go slow. Just on small roads, not highways.
// *Mike: * To shop owner How much to rent two scooters for the day?
// Owner: €25 each for 24 hours. Includes helmet and insurance.
// Anna: See? Not expensive. Come on, live a little!
// Mike: Okay, okay. Do you have automatic ones? I don't want to shift gears.
// Owner: Yes, all our rentals are automatic. Very easy. Twist and go.
// Mike: That sounds better. Okay, I'll do it.
// *Anna: * Yes! This is going to be so fun. We can explore the whole coast.
// Mike: Filling out forms What's the speed limit?
// Owner: On local roads, 40 km/h. Perfect for beginners.
// Mike: Okay. And you have helmets in my size?
// Owner: Try this one. Should fit. How does it feel?
// Mike: Good. Comfortable. Okay, let's do this.
// Anna: Don't worry, Mike. I'll be right behind you. We'll have the best day!
// Mike: I'm holding you to that!

// Dialogue 15: Flight Delay (Задержка рейса)
// Characters: Two passengers, Emma and David, at the airport

// Emma: Did you see the board? Our flight is delayed. Two hours!
// David: What? No! Why?
// Emma: Technical issues with the plane. They're fixing it.
// David: Two hours. That's so frustrating. We were supposed to land at 8.
// Emma: Now it's 10. We'll miss dinner at the hotel.
// David: And I'm already tired. I just want to get there.
// Emma: Same. But better safe than sorry, right? I don't want to fly on a broken plane.
// David: True. Safety first. Still, two hours is a long time.
// Emma: Let's find something to do. There's a bookstore over there.
// David: Good idea. I need a new book anyway.
// Emma: And then coffee. And then maybe a snack. We have time.
// *David: * Haha, true. Might as well make the best of it.
// Emma: Look on the bright side. Free Wi-Fi. We can watch movies.
// David: Or complain to each other for two hours!
// Emma: Haha, that too. Come on, let's explore the airport.
// David: Okay. But if they announce boarding, we run. Deal?
// *Emma: * Deal. Let's go find trouble!
