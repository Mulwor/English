...
export const LifeStages = () => {
  const { data, currentPage, handlePageChange } = usePaginatedData(life_dialogs_01, [life_dialogs_01, life_dialogs_02, life_dialogs_03]);
  ...
  return (
    <>
      ...
      <p>
        ...
        когда мне было 7 лет. Я хорошо учился и любил математику. Я закончил школу в 2014 году.
        <br />
        <br />
        После школы я поступил в университет в Санкт-Петербурге. Это был очень важный этап в моей жизни. Я изучал информатику. В университете у меня появилось
        много новых друзей. Я получил диплом в 2019 году.
        <br />
        <br />
        Моя первая работа была в IT-компании. Я был очень рад! В 2021 году я встретил свою будущую жену. Мы поженились в 2022 году. Это был самый счастливый
        день в моей жизни.
        <br />
        <br />
        Сейчас мне 27 лет. Я все еще работаю программистом. В будущем я хочу стать senior-разработчиком и, возможно, мы с женой планируем завести детей. Я также
