...
export const money_06 = [
  ...
  {
    key: '6',
    english: 'Maybe ask your bank?',
    russian: 'Может, спросить в банке?',
  },
];
...
export const money_07 = [
  {
    ...
    russian: 'Сколько ты тратишь на еду каждый месяц?',
  },
  { key: '2', english: 'Around $200.', russian: 'Около 200 долларов.' },
  {
    key: '3',
    english: 'That’s a lot! I spend only $150.',
    russian: 'Это много! Я трачу только 150 долларов.',
  },
  {
    key: '4',
    english: 'But I eat out a lot.',
    russian: 'Но я часто ем вне дома.',
  },
  {
    key: '5',
    english: 'Maybe you should cook at home?',
    russian: 'Может, тебе стоит готовить дома?',
  },
  {
    key: '6',
