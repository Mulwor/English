export const location_01 = [
  {
    key: '1',
    english: 'Excuse me, sir. Can you tell me where the museum is?',
    russian: 'Извините, сэр. Не могли бы вы сказать, где находится музей?',
  },
  {
    key: '2',
    english:
...
export const location_03 = [
  ...
  {
    key: '3',
    english: 'Thanks! Do you know which bus goes to the train station?',
    russian: 'Спасибо! Вы не знаете, какой автобус идет к вокзалу?',
  },
  {
    key: '4',
