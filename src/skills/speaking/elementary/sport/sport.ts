export const sportsTypes = [
  {
    key: '1',
    english: 'Football',
    pronunciation: '/ˈfʊtˌbɔːl/',
    russian: 'футбол',
  },
  {
    key: '2',
    english: 'Basketball',
    pronunciation: '/ˈbæskɪtˌbɔːl/',
    russian: 'баскетбол',
  },
  { key: '3', english: 'Tennis', pronunciation: '/ˈtɛnɪs/', russian: 'теннис' },
  {
    key: '4',
    english: 'Swimming',
  ...
  { key: '5', english: 'Running', pronunciation: '/ˈrʌnɪŋ/', russian: 'бег' },
  {
    key: '6',
    english: 'Volleyball',
    pronunciation: '/ˈvɒlɪˌbɔːl/',
    russian: 'волейбол',
  },
  { key: '7', english: 'Rugby', pronunciation: '/ˈrʌɡbi/', russian: 'регби' },
  {
    key: '8',
    english: 'Cycling',
  ...
  { key: '9', english: 'Boxing', pronunciation: '/ˈbɒksɪŋ/', russian: 'бокс' },
  {
    key: '10',
    english: 'Gymnastics',
  ...
  { key: '11', english: 'Skiing', pronunciation: '/ˈskiːɪŋ/', russian: 'лыжи' },
  {
    key: '12',
    english: 'Skateboarding',
    pronunciation: '/ˈskeɪtbɔːdɪŋ/',
    russian: 'скейтбординг',
  },
  {
    key: '13',
    english: 'Climbing',
  ...
  { key: '15', english: 'Play', pronunciation: '/pleɪ/', russian: 'играть' },
  {
    key: '16',
    english: 'Train',
    pronunciation: '/treɪn/',
  ...
  { key: '18', english: 'Win', pronunciation: '/wɪn/', russian: 'выигрывать' },
  {
    key: '19',
    english: 'Lose',
    pronunciation: '/luːz/',
  ...
  { key: '22', english: 'Hit', pronunciation: '/hɪt/', russian: 'ударять' },
  { key: '23', english: 'Catch', pronunciation: '/kætʃ/', russian: 'ловить' },
  { key: '24', english: 'Run', pronunciation: '/rʌn/', russian: 'бегать' },
  { key: '25', english: 'Swim', pronunciation: '/swɪm/', russian: 'плавать' },
  { key: '26', english: 'Jump', pronunciation: '/dʒʌmp/', russian: 'прыгать' },
  { key: '27', english: 'Lift', pronunciation: '/lɪft/', russian: 'поднимать' },
  { key: '28', english: 'Serve', pronunciation: '/sɜːv/', russian: 'подавать' },
  { key: '29', english: 'Pass', pronunciation: '/pæs/', russian: 'передавать' },
  {
    key: '30',
    english: 'Block',
    pronunciation: '/blɒk/',
  ...
  { key: '31', english: 'Kick', pronunciation: '/kɪk/', russian: 'пинать' },
  { key: '32', english: 'Goal', pronunciation: '/ɡəʊl/', russian: 'гол' },
];

export const sportsData = [
  { key: '1', english: 'Gym', pronunciation: '/dʒɪm/', russian: 'спортзал' },
  {
    key: '2',
    english: 'Stadium',
    pronunciation: '/ˈsteɪdɪm/',
    russian: 'стадион',
  },
  { key: '3', english: 'Court', pronunciation: '/kɔːt/', russian: 'корт' },
  { key: '4', english: 'Track', pronunciation: '/træk/', russian: 'дорожка' },
  { key: '5', english: 'Pool', pronunciation: '/puːl/', russian: 'бассейн' },
  { key: '6', english: 'Field', pronunciation: '/fiːld/', russian: 'поле' },
  { key: '7', english: 'Ring', pronunciation: '/rɪŋ/', russian: 'ринг' },
  { key: '8', english: 'Rink', pronunciation: '/rɪŋk/', russian: 'каток' },
  { key: '9', english: 'Ball', pronunciation: '/bɔːl/', russian: 'мяч' },
  { key: '10', english: 'Bat', pronunciation: '/bæt/', russian: 'бита' },
  {
    key: '11',
    english: 'Racket',
  ...
  { key: '13', english: 'Helmet', pronunciation: '/ˈhɛlmɪt/', russian: 'шлем' },
  { key: '14', english: 'Shoes', pronunciation: '/ʃuːz/', russian: 'обувь' },
  {
    key: '15',
    english: 'Jersey',
    pronunciation: '/ˈdʒɜːzi/',
    russian: 'футболка',
  },
  { key: '16', english: 'Shorts', pronunciation: '/ʃɔːts/', russian: 'шорты' },
  {
    key: '17',
    english: 'Knee pads',
    pronunciation: '/niː pædz/',
    russian: 'наколенники',
  },
  {
    key: '18',
    english: 'Tennis shoes',
    pronunciation: '/ˈtɛnɪs ʃuːz/',
    russian: 'кроссовки для тенниса',
  },
  {
    key: '19',
    english: 'Skateboard',
...
export const sport_09 = [
  {
    key: '1',
    english: 'I’m thinking about going to the gym.',
    russian: 'Я подумываю начать ходить в спортзал.',
  },
  {
    key: '2',
...
export const sport_11 = [
  {
    ...
    russian: 'Тебе нравится теннис?',
  },
  {
    key: '2',
    english: 'Yes, I like it a lot!',
    russian: 'Да, мне он очень нравится!',
  },
  {
    key: '3',
    english: 'How often do you play?',
    russian: 'Как часто ты играешь?',
  },
  {
    key: '4',
    english: 'I play three times a week.',
    russian: 'Я играю три раза в неделю.',
  },
  {
    key: '5',
    english: 'Wow, that’s a lot! Do you play in a club?',
    russian: 'Ого, это много! Ты играешь в клубе?',
  },
  {
    key: '6',
    english: 'Yes, I play in a tennis club.',
    russian: 'Да, я играю в теннисном клубе.',
  },
  {
    key: '7',
    english: 'That’s cool! How can I join the club?',
    russian: 'Круто! Как я могу вступить в клуб?',
  },
  {
    key: '8',
    english: 'You can go to the tennis center and sign up.',
    russian: 'Ты можешь пойти в теннисный центр и записаться.',
  },
];

export const sport_12 = [
  {
    key: '1',
    english: 'What’s your favorite winter sport?',
    russian: 'Какой твой любимый зимний вид спорта?',
  },
  {
    key: '2',
    english: 'I like skiing a lot!',
    russian: 'Мне очень нравится кататься на лыжах!',
  },
  {
    key: '3',
  ...
  {
    key: '4',
    english: 'Yes, every winter holiday.',
    russian: 'Да, каждую зимнюю каникулу.',
  },
  {
    key: '5',
    english: 'That’s awesome! Is it difficult to learn?',
    russian: 'Здорово! Трудно ли этому научиться?',
  },
  {
    key: '6',
    english: 'It’s not too hard. You just need to practice.',
    russian: 'Не слишком трудно. Нужно просто практиковаться.',
  },
  {
    key: '7',
    english: 'Maybe I’ll try it next winter. Do you ski on big mountains?',
    russian: 'Может, я попробую следующей зимой. Ты катаешься на больших горах?',
  },
  {
    key: '8',
