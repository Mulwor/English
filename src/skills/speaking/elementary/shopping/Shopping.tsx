  ...
  return (
    <div>
      ...
      <a href='https://www.speaklanguages.com/english/phrases/shopping'>
        1. Shopping - here are some English phrases to help you when you go shopping, as well as
        some of the things you might see.
      </a>

      <a href='https://test-english.com/vocabulary/a1/shops-and-shopping-a1-english-vocabulary/'>
        2. Shops and shopping - in this A1 Elementary Vocabulary Lesson, you will learn different
        common types of shops and useful phrases that are used when shopping. Check the explanation
        to learn the words and then do the exercises.
      </a>
    </div>
  );
};
